                ...
                <ul className="flex gap-10">
                    {user ? (
                        ...
                        <>
                            ...
                            <li><a href="/register" className="transition duration-500 hover:text-orange-500 border-2 border-gray-600 bg-black-100 shadow-md shadow-black text-white rounded-full py-2 px-4">Create account</a></li>
                        </>
                    )}
                    <ThemeSwitch />
                </ul>
