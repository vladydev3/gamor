    ...
    return (
        <main className="h-full cursor-default flex pb-4 items-stretch justify-between max-w-screen-lg mx-auto">
            ...
            <div className="flex-1 bg-black-550 rounded-r-3xl ">
                ...
                <div className="flex cursor-pointer bg-black-500 rounded-full p-2 m-auto ml-8 w-3/4 justify-between">
                    <button className="bg-black-550 text-center rounded-full p-2 px-4">Party</button>
                ...
                <div className="bg-black-500 m-10 mt-0 rounded-xl p-4">
                    ...
                    <button className="bg-white text-black rounded-md p-2 w-full mt-4">Search Now</button>
                </div>
            </div>
        </main>
    );
